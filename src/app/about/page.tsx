...
const strengths = [
  ...
  {
    icon: Brain,
    title: "Calm under pressure (thank you, anxiety)",
                  ...
                  >
                    <div className={`flex items-center gap-3 mb-3 ${index % 2 === 0 ? "" : "flex-row-reverse"}`}>
                      ...
                      <div className={index % 2 === 0 ? "" : "text-right"}>
                        <h3 className="text-xl font-bold text-primary-pink">{item.title}</h3>
                        <p className="text-sm text-secondary-teal font-semibold">{item.year}</p>
                        <p className="text-xs text-text-gray italic">{item.subtitle}</p>
                      </div>
                    </div>
                    <p className="text-text-gray dark:text-gray-300 leading-relaxed mb-3">
                      {item.description}
                    </p>
                    <div className={`flex items-center gap-2 text-sm text-primary-pink hover:text-secondary-teal transition-colors ${
